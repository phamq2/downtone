// Advanced taxes-and-reserves view, rendered inside the Returns section and
// driven by its investment slider. One illustrative year, one idea: the cash
// the company keeps in reserve decides how much reaches you, while taxable
// income — a separate assumption — decides what you owe.
...
window.DTTaxWaterfall = function DTTaxWaterfall({ inv }) {
  ...
  return (
    <div style={{ marginTop: 56, borderTop: "1px solid rgba(245,241,234,0.15)", paddingTop: 24 }}>
      <div onClick={() => setOpen(o => !o)} style={{ cursor: "pointer", display: "flex", alignItems: "baseline", gap: 16, flexWrap: "wrap" }}>
        <span className="dt-eyebrow">{open ? "− " : "+ "}Advanced · Taxes &amp; reserves</span>
        <span className="dt-fg-soft dt-serif-it" style={{ fontSize: 13 }}>
          reserves decide the cash that reaches you; taxable income decides what you owe
        </span>
      </div>
