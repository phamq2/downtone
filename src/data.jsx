  ...
  const SPACE_MODELS = [
    {
      ...
      label: "Ground Floor",
      stat: "70 seats · Day to night",
      blurb: "Specialty coffee by day, hi-fi listening bar by night — the same 70-seat room earns across all four dayparts, anchored by the bar and the sound system.",
    ...
    },
    {
      ...
      stat: "25 seats · The Sound Room",
      blurb: "An intimate listening room tuned as its own acoustic environment — ticketed listening sessions, private dining, and curated activations. The second revenue engine, launching September 2027.",
